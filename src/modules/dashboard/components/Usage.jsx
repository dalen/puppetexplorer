      ...
      <Grid>
        <Row>
          <Col md={4}>
            ...
            <p>
              Strings can contain letters, numbers or the characters :-_ without needing to be
            ...
            <p>
              An unquoted number or the strings true/false will be interpreted as numbers and
              boolean values, use quotation marks around them to search for them as strings instead.
            </p>

            <p>
              A <code>@</code> sign before a string causes it to be interpreted as a date parsed
              with <a href="https://github.com/calebcase/timespec"> timespec</a>.
              For example <code>@&quot;now - 2 hours&quot;</code>.
            </p>

            <p>
              A <code>#</code> sign can be used to do a subquery, against the nodes endpoint for
            ...
            <p>
              A bare string without comparison operator will be treated as a regexp match against
              the certname.
            </p>
          </Col>
          ...
          <Col md={4}>
            ...
            <p>
              Shown in precedence order from highest to lowest. Use parenthesis to change order
              in an expression.
            </p>
          </Col>
