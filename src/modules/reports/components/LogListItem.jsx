...
export default class LogListItem extends React.Component<Props> {
  ...
  render() {
    ...
    return (
      <tr>
        ...
        <td>
          <Label bsStyle={LogListItem.color(log.level)} style={{ textTransform: 'capitalize' }}>
            {log.level}
          </Label>
        </td>
        <td>
          {LogListItem.message(log.message)}
          <span>
